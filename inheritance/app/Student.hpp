...
public:
    ...
    // since it's already marked virtual in the Person class, and the
    // override specifier already implies virtualness, so it's generally
    // not recommended to say both "virtual" and "override" (though it's
    // technically harmless to say both).
